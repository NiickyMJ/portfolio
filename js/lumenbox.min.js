// Source : https://www.cssscript.com/image-gallery-lightbox-lumenbox/
...
! function (u, c) {
    ...
    "undefined" != typeof module && void 0 !== module.exports ? module.exports = n : "function" == typeof define && define.amd ? define([], function () {
        ...
        if (!c.getElementById("lumenbox")) {
            var e = this;
            c.body.insertAdjacentHTML("beforeEnd", '<div id="lumenbox-overlay" class="lumenbox-overlay"></div><div id="lumenbox" class="lumenbox">\t<div class="lumenbox-container">    <img src="" alt="" id="lumenbox-img"/>    <div class="lumenbox-info">      <span id="lumenbox-caption"></span>      <span id="lumenbox-counter"></span>    </div>    <div id="lumenbox-navigation">      </span>    </div>  </div>\t<div id="lumenbox-close">\t\t<span>×</span>\t</div></div>'), this.backDrop = c.getElementById("lumenbox-overlay"), this.lumenbox = c.getElementById("lumenbox"), this.closeButton = c.getElementById("lumenbox-close"), this.prevButton = c.getElementById("lumenbox-prev"), this.nextButton = c.getElementById("lumenbox-next"), this.caption = c.getElementById("lumenbox-caption"), this.counter = c.getElementById("lumenbox-counter"), this.options.backDropClose && this.backDrop.addEventListener("click", function () {
                return e.finish(), !1
        ...
        this.gallery = [];
        var n = 0;
        var i, o, a = t.getAttribute("data-lumenbox");
        if (a) {
            i = c.querySelectorAll('[data-lumenbox="' + a + '"]');
            for (var r = 0; r < i.length; r = ++r) o = {
        ...
        var t, e, n, i, o = c.getElementById("lumenbox-img");
